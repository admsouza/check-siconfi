...
from ..d2_00008 import d2_8_desp_por_funcao



API_URL = API_DCA

def get_dca_i_e(id_ente, an_exercicio):
    """
...
def main(id_ente, an_exercicio):
    ...
    df = get_dca_i_e(id_ente, an_exercicio)
    
    # Processa os dados usando o mesmo DataFrame
    desp_por_funcao = d2_8_desp_por_funcao (df)

    return desp_por_funcao
